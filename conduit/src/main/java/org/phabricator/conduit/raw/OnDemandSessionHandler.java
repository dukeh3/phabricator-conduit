...
public class OnDemandSessionHandler implements SessionHandler {
   ...
   */
  public OnDemandSessionHandler( String username, String certificate) {
    conduitModule = null;
  ...
  public void fillInSession(final Map<String, Object> params)
    ...
    if (sessionKey == null) {
      ...
      final ConduitModule.ConnectResult connectResult = conduitModule.connect(username, certificate);
