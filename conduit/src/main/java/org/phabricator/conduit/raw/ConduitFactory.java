...
public class ConduitFactory {
  public static Conduit createConduit(final String baseUrl,
    ...
    final OnDemandSessionHandler sessionHandler = new OnDemandSessionHandler(username, certificate);
  ...
  public static Conduit createConduit(final String baseUrl,
	    ...
	    final ApiSessionHandler sessionHandler = new ApiSessionHandler(apiToken);
