...
import org.phabricator.conduit.raw.OnDemandSessionHandler;
import org.phabricator.conduit.raw.SessionHandler;

public class OnDemandSessionHandlerTest extends SessionTestCase {
	public void testFillInSessionWithoutConduit() {
		final Map<String, Object> params = new HashMap<String, Object>();

		final SessionHandler sessionHandler = new OnDemandSessionHandler(null, null);
	...
	public void testFillInSessionEmptyParams() throws ConduitException {
		final ConduitModule.ConnectResult connectResult = new ConduitModule.ConnectResult(1, "sessionKeyFoo",
				"userBar");

		final ConduitModule conduitModule = createMock(ConduitModule.class);
		expect(conduitModule.connect(null, null)).andReturn(connectResult);

		final Map<String, Object> params = new HashMap<String, Object>();

		replayMocks();

		final OnDemandSessionHandler sessionHandler = new OnDemandSessionHandler(null, null);
	...
	public void testFillInSessionReuseSessios() throws ConduitException {
		final ConduitModule.ConnectResult connectResult = new ConduitModule.ConnectResult(2, "sessionKeyFoo",
				"userBar");

		final ConduitModule conduitModule = createMock(ConduitModule.class);
		expect(conduitModule.connect(null, null)).andReturn(connectResult).once();
